...
void Menu::Inicializa(float largura, float altura)
{
	...
	menu[1].setPosition(Vector2f(largura / 2.0f, altura / (float)(N_elementos + 1) * 1.0f));
	menu[1].setCharacterSize(20);

	menu[2].setFont(font);
	menu[2].setFillColor(Color::White);
	menu[2].setString("Fase 2-Em busca do bloco N");
	menu[2].setPosition(Vector2f(largura / 2.0f, altura / (float)(N_elementos + 1) * 2));
	menu[2].setCharacterSize(20);

	menu[3].setFont(font);
	menu[3].setFillColor(Color::White);
	menu[3].setString("Sair");
	menu[3].setPosition(Vector2f(largura / 2.0f, altura / (float)(N_elementos + 1) * 3));
