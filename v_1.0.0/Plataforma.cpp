...
void Plataforma::Inicializa1()
{
	...
	criaBase(Vector2f(520.0f, 80.0f), Vector2f(260.0f, 350.0f));
...
void Plataforma::Inicializa2()
{
	...
	int i;
	Vector2f tamanho(100.0f, 100.0f);
	Vector2f posicao(1415.0f, 790.0f);
	...
	criaBase(Vector2f(350.0f, 80.0f), Vector2f(1400.0f, 480.0f));

	criaBase(Vector2f(100.0f, 50.0f), Vector2f(1450.0f, 350.0f));

	criaBase(Vector2f(390.0f, 70.0f), Vector2f(1770.0f, 220.0f));
