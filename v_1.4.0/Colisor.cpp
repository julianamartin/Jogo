...
{
	Vector2f outraPos = outroObj.getPosição(); //Posição do outro Objeto
	Vector2f outraMetade = outroObj.getMetade(); //Metade do tamanho do outro objeto 
	Vector2f essaPos = getPosição(); //Posição do próprio Objeto
	Vector2f essaMetade = getMetade(); //Metade do tamanho do próprio objeto 
