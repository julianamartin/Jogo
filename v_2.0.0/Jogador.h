...
public:
	...
	float getTempo() { return tempo.getValor(); }
	float getEnergia() { return energia.getValor(); }
	float getDinheiro() { return dinheiro.getValor(); }
	void setTempo(float t) { tempo.setValor(t); }
	void setEnergia(float e) { energia.setValor(e); }
	void setDinheiro(float d) { dinheiro.setValor(d); }
	bool esgotou();
